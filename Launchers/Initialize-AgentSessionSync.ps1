...
try {
    ...
    if (-not (Test-Path -LiteralPath $configPath -PathType Leaf)) {
        ...
        $body = @(
            ...
            '',
            '        # Lineage transcripts confirmed gone, keyed by the',
            '        # appSessionId of the conversation that refers to them.',
            '        # Nothing is added here automatically; a new loss needs a',
            '        # new explicit entry. See the public example configuration.',
